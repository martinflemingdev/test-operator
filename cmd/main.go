...
import (
	...
	"github.com/martinflemingdev/test-operator/internal/controller"
...
func init() {
	...
	utilruntime.Must(enterprisev1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "94b6508e.mftest.com",
